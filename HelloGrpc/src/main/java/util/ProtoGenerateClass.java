...
public class ProtoGenerateClass {
	// protoc的目录
	private static final String PROTOC_FILE = "C:/tools/protoc-3.13.0-win64/bin/protoc.exe";
	// specifies a directory in which to look for .proto files when resolving import directives
	private static final String IMPOR_TPROTO = "C:/10_tmp";
	// 生成java类输出目录
	private static final String JAVA_OUT = "C:/10_tmp";
	// 指定proto文件
	private static final String protos = "C:/10_tmp/*.proto";
